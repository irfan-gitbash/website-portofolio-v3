        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Full Stack Web Dev .png"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Javascript Certification.PNG"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Sertifikat Responsive Web Design.PNG"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Dicoding-web-dasar.png"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Solo-learn-Javascript.png"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/Dicoding-front-end-web-dev.png"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/dicoding-belajar dasar-pemograman-javascript.png"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-colors duration-200">
              <img
                src="/images/dicoding-belajar-dasar-ai.png"
                className={`w-full h-48 object-cover transition-transform duration-300 ${
                  isZoomed ? "scale-125" : "scale-100"
                }`}
                onClick={() => setIsZoomed(!isZoomed)}
